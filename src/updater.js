...
var repo = octo.repos('Infinite-Coder-001', 'khanapi-2'); // Loading the repo
  ...
  getHotlist((hotlist) => {
    ...
    for (var i = 0; i < 100; i ++) {
      programs.push({
        ...
        author: {
          nickname: hotlist.data.listTopPrograms.programs[i].authorNickname, 
    ...
    console.log("Hotlist - update - " + String(day) + "-" + String(month) + "-" + String(year) + " " + String(hours) + ":" + String(minutes)); 
    ...
    function clearOldHotlistLogs(delay) {
      ...
      // Removing the file
      githubRemove("data/hotlist-" + String(year) + String(month) + String(day) + String(hours) + String(minutes) + ".js", "Hotlist - remove - " + String(day) + "-" + String(month) + "-" + String(year) + " " + String(hours) + ":" + String(minutes), (success) => {
        if (success) {
